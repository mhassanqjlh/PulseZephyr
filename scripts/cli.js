...
const contractABI = require("../artifacts/contracts/Pulsezephyr.sol/Pulsezephyr.json").abi;

program
    .name("pulsezephyr-cli")
    .description("CLI tool for Pulsezephyr smart contract")
    .version("1.0.0");
